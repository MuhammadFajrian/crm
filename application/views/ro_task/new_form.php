                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="<?php echo site_url('administrasi/add') ?>" method="post">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label for="start_date">Target Mulai *</label>
                                            <input class="form-control <?php echo form_error('start_date') ? 'is-invalid':'' ?>"
                                            type="text" id="start_date" name="start_date" placeholder="dd-mm-yyyy" />
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            type="text" id="end_date" name="end_date" placeholder="dd-mm-yyyy" />
                                            <div class="invalid-feedback">
                                                <?php echo form_error('name') ?>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    name="address" id="address" placeholder="Alamat Badan Usaha" readonly></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    type="text" name="data_source" placeholder="Sumber Data" />
                                    <div class="invalid-feedback">
