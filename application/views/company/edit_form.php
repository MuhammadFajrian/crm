                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    type="text" name="name" placeholder="Company name" value="<?php echo $company->name ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    name="address" placeholder="Company Address"><?php echo $company->address ?></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    type="text" name="pic_name" placeholder="PIC name" value="<?php echo $company->pic_name ?>" />
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    type="text" name="contact" placeholder="Phone number" value="<?php echo $company->contact ?>"/>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    type="text" name="email" placeholder="Email" value="<?php echo $company->email ?>" />
                                    <div class="invalid-feedback">
